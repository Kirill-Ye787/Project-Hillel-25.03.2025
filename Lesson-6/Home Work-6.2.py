# Програма конвертує секунди у дні, години, хвилини та секунди
seconds = int(input("Введіть кількість секунд (від 0 до 8639999): "))

if 0 <= seconds < 8640000:
    # Знаходимо дні і залишок секунд
    ...
    # Правильна форма для "день/дні/днів"
    ...
    # Форматований результат з провідними нулями
